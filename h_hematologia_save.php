...
if ((isset($_POST['h_hematologia_save'])) and (isset($_GET['examen_id']))){
    ...
    if ($row['examen_id']==$examen_id) {
        ...
        t_protrombina='$t_protrombina',t_p__tromboplastina= '$t_p__tromboplastina',grupo='$grupo',rh='$rh',
    ...
    reticulocitos,vsg,t_sangria,t_coagulacion,t_protrombina,t_p__tromboplastina,grupo,rh,bacteriologo) 
    ...
    '$t_p__tromboplastina','$grupo','$rh','$bacteriologo')";
