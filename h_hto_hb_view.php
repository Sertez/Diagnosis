    ...
    <div class="container p-4 con" id="contenido">
        <div class="card card-body">
            ...
            <?php
                ...
                ?>
            <?php
                $query = "SELECT * FROM h_hto_hb WHERE examen_id=$examen_id";
                $ex_query = mysqli_query($conn, $query);
                $row = mysqli_fetch_array($ex_query);
                ...
                <div class="col-sm-6">
                    <div class="card" id="formulario">
                        ...
                        <div class="form-group row">
                                ...
                                <label for="ref" class="col-sm-4 col-form-label"></label>
                            </div>
                        <div class="form-group row">
                                ...
                                <label for="ref" class="col-sm-4 col-form-label">M:11-14; H:12-16gr/dl</label>
                            </div>
                    </div>
                </div>
                </div>
