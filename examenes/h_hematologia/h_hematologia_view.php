    ...
    <div class="container p-4 con" id="contenido">
        <div class="card card-body" id="card">
            ...
            <?php
                ...
                $t_p__tromboplastina = $row['t_p__tromboplastina'];
                $grupo = $row['grupo'];
                $rh = $row['rh'];
                ...
                <div class="col-sm-4">
                    <div class="card" id="formulario">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="t_p__tromboplastina" class="col-sm-4 col-form-label">Tiempo Parcial de Tromboplastina</label>
                                <div class="col-sm-4">
                                    <input type="text" name="t_p__tromboplastina" class="form-control" value="<?php echo $t_p__tromboplastina ?>" readonly>
                                </div>
                                <label for="ref" class="col-sm-4 col-form-label">+/- 2 Seg del control'</label>
                            </div>
                            <div class="form-group row">
