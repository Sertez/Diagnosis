    ...
    <div class="container p-4 con" id="contenido">
        <div class="card card-body">
            ...
            <?php
                ...
                ?>
            <?php
                $query = "SELECT * FROM h_esp WHERE examen_id=$examen_id";
                $ex_query = mysqli_query($conn, $query);
                $row = mysqli_fetch_array($ex_query);
                $serie_roja = $row['serie_roja'];
                $serie_blanca = $row['serie_blanca'];
                $serie_plaquetaria = $row['serie_plaquetaria'];
                    ...
                    <div class="card" id="formulario">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="serie_roja" class="form-control" value="<?php echo $serie_roja ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="serie_blanca" class="col-sm-6 col-form-label">Serie Blanca</label>
                                <div class="col-sm-6">
                                    <input type="text" name="serie_blanca" class="form-control" value="<?php echo $serie_blanca ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="serie_plaquetaria" class="col-sm-6 col-form-label">Serie Plaquetaria</label>
                                <div class="col-sm-6">
                                    <input type="text" name="serie_plaquetaria" class="form-control" value="<?php echo $serie_plaquetaria ?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
