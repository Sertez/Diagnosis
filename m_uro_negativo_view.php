    ...
    <div class="container p-4 con" id="contenido">
        <div class="card card-body">
            ...
            <?php
                ...
                ?>
            <?php
                $query = "SELECT * FROM m_uro_negativo WHERE examen_id=$examen_id";
                $ex_query = mysqli_query($conn, $query);
                $row = mysqli_fetch_array($ex_query);
                    ...
                    <div class="card" id="formulario">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="BK" class="col-sm-6 col-form-label">Urocultivo</label>
                                <div class="col-sm-6">
                                    <input type="text" name="baciloscopia" class="form-control" value="Negativo" readonly>
                                </div>
                            </div>
                    </div>
                </div>
