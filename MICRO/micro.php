...
<?php if (isset($_GET['examen_id'])) {
    ...
    $BK1 = "";
    $bacteriologo1= "";
    $query = "SELECT * FROM p_bk WHERE examen_id='$id1'";
    ...
    <div class="container p-4 con" id="contenido">
        <form action="micro_save.php?examen_id=<?php echo $_GET['examen_id'] ?>" method="POST">
            <div class="card card-body">
                        ...
                        <div class="card" id="formulario">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="BK1" value="<?php echo $BK1?>" class="form-control" placeholder="" autofocus>
                                    </div>
                                </div>                                
                            </div>
                        </div>
                ...
                <input type="submit" class="btn btn-success btn-block" name="micro_save" value="Agregar o Editar Examen">
            </div>
        </form>
    </div>
<?php } else {
