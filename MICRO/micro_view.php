    ...
    <div class="container p-4 con" id="contenido">
        <div class="card card-body">
            ...
            <?php
                ...
                ?>
            <?php
                $query = "SELECT * FROM p_bk WHERE examen_id=$examen_id";
                $ex_query = mysqli_query($conn, $query);
                $row = mysqli_fetch_array($ex_query);
                $BK1 = $row['BK1'];
                    ...
                    <div class="card" id="formulario">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="BK" class="col-sm-6 col-form-label">BK</label>
                                <div class="col-sm-6">
                                    <input type="text" name="BK" class="form-control" value="<?php echo $BK1 ?>" readonly>
                                </div>
                            </div>
                    </div>
                </div>
