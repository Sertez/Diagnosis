                ...
                <div class="col-sm-4">
                    <div class="card" id="formulario">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="acido_urico" class="col-sm-4 col-form-label">Acido Urico</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                <label for="nitrogeno_ureico" class="col-sm-4 col-form-label">Nitrogeno Ureico</label>
                                <div class="col-sm-4">  
                            ...
                            <div class="form-group row">
                                <label for="alanino_aminotrans" class="col-sm-4 col-form-label">Alanino Aminotrans</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                <label for="aspartato_aminotrans" class="col-sm-4 col-form-label">Aspartato Aminotrans</label>
                                <div class="col-sm-4">
