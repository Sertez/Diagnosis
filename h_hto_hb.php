...
<?php if (isset($_GET['examen_id'])) {
    ...
    $hemoglobina = "";
    $bacteriologo1= "";
    $query = "SELECT * FROM h_hto_hb WHERE examen_id='$id1'";
    ...
    <div class="container p-4 con" id="contenido">
        <form action="h_hto_hb_save.php?examen_id=<?php echo $_GET['examen_id'] ?>" method="POST">
            <div class="card card-body">
                <div class="card-header" id="extitle">
                    Crear o Editar HTO HB
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="card" id="formulario">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="hematocrito" value="<?php echo $hematocrito?>" class="form-control" placeholder="" autofocus>
                                    </div>
                                </div>     
                                <div class="form-group row">
                                    <label for="hemoglobina" class="col-sm-6 col-form-label">Hemoglobina</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="hemoglobina" value="<?php echo $hemoglobina?>" class="form-control" placeholder="" autofocus>
                                    </div>
                                </div>                         
                            </div>
                        </div>
                ...
                <input type="submit" class="btn btn-success btn-block" name="h_hto_hb_save" value="Agregar o Editar Examen">
            </div>
        </form>
    </div>
<?php } else {
