...
<?php if (isset($_GET['examen_id'])) {
    ...
    $vdrl1 = "";
    $bacteriologo1= "";
    $query = "SELECT * FROM h_vdrl WHERE examen_id='$id1'";
...
<div class="container p-4 con" id="contenido">
        <form action="h_vdrl_save.php?examen_id=<?php echo $_GET['examen_id'] ?>" method="POST">
            <div class="card card-body">
                <div class="card-header" id="extitle">
                    Inmunologia otra vez
                </div>
                <div class="row">
                    <div class="col-sm-6">
                ...
                <input type="submit" class="btn btn-success btn-block" name="h_vdrl_save" value="Agregar o Editar Examen">
            </div>
        </form>
    </div>
<?php } else {
