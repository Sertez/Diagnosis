...
<?php if (isset($_GET['examen_id'])) {
    ...
    if(mysqli_num_rows($result2) == 1){
        ...
        $t_p_tromboplastina1= $row['t_p_tromboplastina'];
        $grupo1= $row['grupo'];
        $rh1= $row['rh'];
                    ...
                    <div class="col-sm-6">
                        <div class="card" id="formulario">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="t_p_tromboplastina" class="col-sm-6 col-form-label">Tiempo Parcial de Tromboplastina</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="t_p_tromboplastina" value="<?php echo $t_p_tromboplastina1?>"class="form-control" placeholder="tromboplastina" autofocus>
                                    </div>
                                </div>
                                <div class="form-group row">
